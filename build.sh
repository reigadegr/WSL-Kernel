...
wget https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-5.15.6.tar.xz > /dev/null 2>&1
tar xvf linux-5.15.6.tar.xz > /dev/null 2>&1
...
cd ..
mkdir "artifact"
mv linux-5.15.6/arch/x86/boot/bzImage artifact/
